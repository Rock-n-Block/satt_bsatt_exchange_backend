...
from blockchain_common.eth_tokens import erc223_abi
...
class EthNetwork(WrapperNetwork):
    ...
    def get_processed_tx_receipt(self, tx_hash, token_name):
        ...
        #processed = self.erc20_contracts_dict[token_name].functions.transfer(Web3.toChecksumAddress(to_address), int(amount), bytes(data))
